            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-auto">
                            <h4 class="card-title">Manajemen Data Kios</h4>
                        </div>
                        ...
                        <table id="myTable" class="table table-bordered table-striped w-100 align-middle">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" style="width: 120px">Status Kios</th>
                                    <th class="text-center" style="width: 120px">Lokasi Kios</th>
